...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('authors').insert(
    {
			...
			image: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/kyle_simpson.jpg"
    }),
    ...
    knex('authors').insert(
    {
      ...
      image: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/bonnie_eisenman.jpg'
    }),
    ...
    knex('authors').insert(
    {
      ...
      image:'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg'
    })
